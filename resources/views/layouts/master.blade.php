          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="http://ssl.gstatic.com/accounts/ui/avatar_2x.png" alt="..." class="img-circle profile_img">
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fas fa-user-lock"></i></i>&nbsp&nbsp&nbsp Power <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="/admin/permissions">Permission</a></li>
                      <li><a href="/admin/colors">Roles</a></li>
                    </ul>
                   </li>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li role="presentation" class="dropdown">
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <li>
                      <a>
                        <span class="image"><img src="http://ssl.gstatic.com/accounts/ui/avatar_2x.png" alt="Profile Image" /></span>
                        <span>
                          <span>Đinh Xuân Dương</span>
